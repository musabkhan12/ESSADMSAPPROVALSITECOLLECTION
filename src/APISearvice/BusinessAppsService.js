...
export const fetchAutomationDepartment = async (_sp) => {
  ...
  await _sp.web.lists.getByTitle("ARGAutomationDepartment").items().then((res) => {
    console.log(res);
...
export const fetchAutomationCategory = async (_sp) => {
  ...
  await _sp.web.lists.getByTitle("BusinessAppsCategory").items().then((res) => {
    console.log(res);
...
export const ARGBusinessAppCategory = async (sp) => {
  ...
  let arr = []
  let arrs = []
  await sp.web.lists.getByTitle("BusinessAppsCategory").items.orderBy("Created", false)().then((res) => {
...
export const getBusinessApps = async (_sp) => {
  ...
  await _sp.web.lists.getByTitle("ARGBusinessApps")
    .items.select("*,EntityMaster/ID,EntityMaster/Entity,Category/ID,Category/CategoryName").expand("EntityMaster,Category").orderBy("Created", false)()
    .then((res) => {
      console.log(res);
...
//   await _sp.web.lists.getByTitle("AllApprovalLists").items.orderBy("Created", false)()
//     .then(async (res) => {
