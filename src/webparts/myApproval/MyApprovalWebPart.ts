...
export default class MyApprovalWebPart extends BaseClientSideWebPart<IMyApprovalWebPartProps> {

  private _isDarkTheme: boolean = false;
  private _environmentMessage: string = '';

  public render(): void {
    const element: React.ReactElement<IMyApprovalProps> = React.createElement(
      MyApproval,
      {
