...
export const CommentEventCard: React.FC<{
  commentId: number;
  username: string;
  Commenttext: string;
  Comments: any;
...
}> = ({ commentId, username, Commenttext, Comments, Created, likes, replies, userHasLiked, CurrentUserProfile, loadingLike, onAddReply, onLike, loadingReply, EventArray, siteUrl, CurrentUserEmail, CurrSPSPicturePlaceholderState }) => {
  const sp: SPFI = getSP();
      ...
      submitButton.onclick = async () => {
        ...
        try {
          ...
          const payload = {
            ...
            Status: "Pending",
            ListName: flag === "replies" ? "ARGEventsUserComments" : "ARGEventsComments",
  ...
  { console.log("CommentsComments,", Comments, commentId)}
  return (
      ...
      <div className="nose">
        <div className="row">
          <div className="d-flex align-items-start">
            ...
            {Comments[commentId].SPSPicturePlaceholderState == 0 ?
              <img
          ...
          <div className="mt-0 mb-2 d-flex" style={{ gap: '2rem' }}>
            ...
            <div style={{ display: 'flex', fontSize: '0.765625rem', alignItems: 'center', gap: '0.2rem' }}>
              <MessageSquare size={14} />  {replies.length} Replies
            </div>
