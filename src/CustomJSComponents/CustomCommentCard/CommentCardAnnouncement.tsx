      ...
      <div className="">
        <div className="row">
          ...
          {Number(Comments[commentId].SPSPicturePlaceholderState) == 0 ?
              ...
              <Avatar sx={{ bgcolor: 'primary.main' }} className="me-2 mt-0 avatar-sm rounded-circle fontl">
                ...
                <div className="d-flex align-items-start">
                  <div className="al nice me-2">
                    ...
                    {Number(CurrSPSPicturePlaceholderState) == 0 ?
                      ...
                      <Avatar sx={{ bgcolor: 'primary.main' }} className="w30 avatar-sm rounded-circle fontl">
